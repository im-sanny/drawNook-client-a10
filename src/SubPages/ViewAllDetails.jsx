...
const ViewAllDetails = () => {
  ...
  const { id } = useParams();
  const idInt = id;
  const allArt = allDetails.find((allDetail) => allDetail._id === idInt);
  console.log(allArt);
  return (
    <div className="mx-2 lg:0 md:0">
      <>
      <div className="footer footer-center my-5 p-4 bg-green-100 text-base-content text-4xl rounded-md mb-10">
          <aside>
            <p>Details</p>
          </aside>
        </div>
        ...
        <div className="my-10">
          <div
            ...
            style={{
              backgroundImage:
                "url(https://i.ibb.co/smkNTYM/color-pencils-8127500-1920.jpg)",
            }}
          >
            ...
            <div className="hero-content text-center text-neutral-content">
              <div className="max-w-4xl">
                <h1 className="mb-5 text-5xl font-bold">
                  Little Information <br /> about us!
                </h1>
                <section className="p-4 my-6 md:p-8 bg-base-300 rounded-md">
        ...
        <div>
          <section className="dark:bg-gray-100 border-yellow-100 border-2 dark:text-gray-800 rounded-md">
            <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12 my-5">
              ...
              >
                ...
                <div className="p-6 space-y-2 lg:col-span-5">
                  ...
                  <p className="text-2xl">{allArt?.description}</p>
                  <div>
                    <div className="">
